...
05/21/18: **Multilanguage version of `RmecabKo`, `RcppMeCab` is uploaded on [Github](https://github.com/junhewk/RcppMeCab).** It's developing currently, and main architecture of `RmecabKo` will be substituted by it.
